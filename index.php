        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="userDropdown" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="text-capitalize">Hi, <?php echo $_SESSION[nama]; ?> <i class="fas fa-user fa-fw"></i></a>
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseDatabuku" aria-expanded="false" aria-controls="collapseDatabuku">
                                <div class="sb-nav-link-icon"><i class="fas fa-book-open"></i></div>
                                Data Buku
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapseDatabuku" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                            ...
                            <div class="collapse" id="collapseLaporan" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="?page=transaksi&aksi=cetak"><small>Laporan Transaksi</small></a>
                                </nav>
                            </div>
                        <?php }?>
                    </div>
                ...
                <div class="sb-sidenav-footer">
                    <div style="color: white; padding: 5px 50px 5px 50px; float: none; font-size: 14px;"><?php echo date('d-M-Y'); ?> &nbsp; 
                    </div>
                </nav>
            </div>
