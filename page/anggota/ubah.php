        ...
        <div class="col-md-12">
            <form method="POST" >
                ...
                <select class="form-control" name="kelas">
                    ...
                    <input class="form-control" type="text" name="user" value="<?php echo $tampil['username']?>"  />
                    
                </div>

                 <div class="form-group">
                    <label>Password</label>
                    <input class="form-control" type="text" name="pass" value="<?php echo $tampil['password']?>"  />
 ...
 <?php
    ...
    $pass = $_POST['pass'];
 	...
 	if ($simpan) {
 		...
 		$sql = $koneksi->query("update  tb_anggota set nama='$nama', tempat_lahir='$tmpt_lahir', tgl_lahir='$tgl_lahir', jk='$jk', kelas='$kelas', username='$user', password='$passbaru' where nis='$nis' ");
 		if ($sql) {
 			?>
